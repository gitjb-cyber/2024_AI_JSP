...
public class BeanContainer {
     ...
     * @param <T>
     */
    public static <T> T getBean(Class<T> clazz, boolean isPrototype) { // 객체 조회 지네릭 메서드, Class 클래스
        // Class 클래스 - 어떤 객체인지 확인, 동적 조회
        // isPrototype 기본값 false - 싱글톤 패턴으로
     ...
     * @param <T>
     */
    public static <T> T getBean(Class<T> clazz) { // 메서드 오버로드 싱글톤 패턴 고정
